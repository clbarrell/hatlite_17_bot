...
public class MyBot {
    ...
    final static GameMap gameMap = networking.initialize("Nastybit");
        ...
        try {
            ...
            for (;;) {
                ...
                for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                    ...
                    // if too many enemies nearby
                    // if (gameMap.nearbyShipDensity(ship) <= 0) {
                    //     // head to nearest friend
                    //     ArrayList<Ship> myShips = gameMap.nearbyMyShipsByDistance(ship);
                    //     final ThrustMove newThrustMove1 = Navigation.navigateShipToDock(gameMap, ship, myShips.get(0), Constants.MAX_SPEED);
                    //         if (newThrustMove1 != null) {
                    //             moveList.add(newThrustMove1);
                    //             ship.logMyAction("moving to friend");
                    //             madeTurn = true;
                    //         } else {
                    //             ThrustMove newThrustMove = Navigation.navigateShipToEnemyShip(gameMap, ship, myShips.get(1), Constants.MAX_SPEED);
